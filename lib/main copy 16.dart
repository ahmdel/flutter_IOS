...
class _MainScreenState extends State<MainScreen>
  ...
  //   await _checkForUpdates(); // ۲. بررسی اجباری بودن آپدیت اپلیکیشن (هر ۳ ماه یک‌بار)

  //  // ۳. دریافت شناسه یکتای دستگاه از متد اختصاصی خودتان
  //   String? deviceId = await _getDeviceId();
  //   if (deviceId == null) {
  //     // اگر آیدی دستگاه به هر دلیلی دریافت نشد، برای امنیت بیشتر دسترسی را محدود کن
  //     setState(() {
  //       _hasPaid = false;
  //       _remainingDays = 0;
  //     });
        ...
        return AlertDialog(
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // فیلد ایمیل کاربر جهت هماهنگی بعدی
                  // TextFormField(
                  //   controller: emailController,
                  //   keyboardType: TextInputType.emailAddress,
                  //   decoration: const InputDecoration(
                  //     labelText: "ایمیل شما (جهت تماس و هماهنگی)",
          ...
          actions: [
            ...
            ElevatedButton(
              ...
              child: const Text("ارسال درخواست", style: TextStyle(color: Colors.white)),
            ),
          ],
        );
      },
  ...
  Future<void> _sendRestaurantProposal({
    ...
    try {
      if (await canLaunchUrl(emailUri)) {
        ...
        _showErrorMessage('امکان باز کردن مستقیم برنامه ایمیل وجود ندارد. لطفاً مشخصات را به آدرس ahmdel@gmail.com ایمیل کنید.');
      }
    } catch (e) {
