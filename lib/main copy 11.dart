...
Future<void> _resetPaymentStatusForTesting() async {
  ...
  if (_selectedCity == "اطراف من") {
    ...
    } else if (_selectedCity == "DE Towns") {
    // اضافه شدن این بخش: فراخوانی مستقیم رستوران‌های DE Towns
    filteredRestaurants = RESTAURANTS_DATA["DE Towns"] ?? [];
    } else if (_selectedCity == "Restworld") {
    // اضافه شدن این بخش: فراخوانی مستقیم رستوران‌های Restworld
  ...
  return Column(
    children: [
      _buildCountryCitySelectors(), // نمایش لیست شهرها
