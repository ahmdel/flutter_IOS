...
Widget _buildRestaurantItem(Restaurant restaurant, String detail) {
    // ⭐️ تابع کمکی برای بررسی اینکه آیا اطلاعات معتبر هستند یا خیر (حذف null و N/A)
    ...
    return Card(
      ...
      child: Padding(
        ...
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.end, // راست‌چین برای زبان فارسی
          children: [
            // ردیف اول: نام رستوران و امتیاز (در صورت وجود)
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                // بخش امتیاز (سمت چپ) - فقط اگر معتبر بود نشان داده می‌شود
                if (isValid(restaurant.rating))
                  ...
                  const SizedBox(), // اگر امتیاز نبود، فضای خالی بماند

                // نام رستوران (سمت راست)
                Expanded(
                  child: Text(
                    restaurant.name,
            ...
            // ⭐️ بخش چهارم: چیپ‌های اطلاعاتی (ساعت کار، قیمت، پارکینگ) 
            // این ویژگی‌ها به صورت پویا فقط در صورت موجود بودن نمایش داده می‌شوند
            Wrap(
              spacing: 8,
              runSpacing: 8,
            ...
            // بخش پنجم: دکمه مسیریابی شکیل و تمام‌عرض
            SizedBox(
              width: double.infinity,
