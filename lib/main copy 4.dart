...
Widget _buildRestaurantItem(Restaurant restaurant, String detail) {
    ...
    // ویجت کمکی برای ردیف‌های اطلاعات تماس (تلفن، سایت، آدرس)
    Widget buildContactRow(IconData icon, String text, Color iconColor) {
      return Padding(
          ...
          children: [
            Expanded(
              child: Text(
                ...
                textDirection: TextDirection.ltr, // چپ‌چین برای خوانایی بهتر اعداد و انگلیسی
    ...
    // بررسی اینکه آیا حداقل یکی از اطلاعات تماس موجود است یا خیر
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            // ⭐️ باکس جدید اطلاعات تماس (آدرس، تلفن، وب‌سایت) ⭐️
            if (hasContactInfo) ...[
              const SizedBox(height: 16),
              Container(
                ...
                child: Column(
                  children: [
                    if (isValid(restaurant.address))
                      buildContactRow(Icons.location_on_outlined, restaurant.address!, Colors.red.shade400),
                    if (isValid(restaurant.phone))
                      buildContactRow(Icons.phone_outlined, restaurant.phone!, Colors.teal.shade600),
                    if (isValid(restaurant.website))
                      buildContactRow(Icons.language_outlined, restaurant.website!, Colors.indigo.shade500),
                  ],
                ),
              ),
            ],
