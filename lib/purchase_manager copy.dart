...
class PurchaseManager {
  ...
  Future<void> _grantPremiumAccess(PurchaseDetails purchaseDetails, String userId) async {
    ...
    if (deviceId != null) {
      try {
        ...
        // این کار باعث می‌شود گوگل این محصول را یکپارچه مصرفی بشناسد 
        // و کاربر بتواند بعد از ۶ ماه دوباره همین محصول را بخرد.
...
class AppAdManager {
  ...
  void initAdUnits() {
    if (!AppTimelineManager().isTestingMode) { // real mode 
      _interstitialUnitId = 'ca-app-pub-1909436077319120/3841330206'; // real interstitial 
      _rewardedUnitId = 'ca-app-pub-1909436077319120/2700317549';
      _bannerUnitId = 'ca-app-pub-1909436077319120/2442968145'; // واقعی: Tanken_Banner_buttom
    }
  }
